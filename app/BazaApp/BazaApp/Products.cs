...
namespace BazaApp
{
    class Products : Interface
    {
        ...
        public string IdRowName { get => "id_products"; }
        ...
        public bool DeleteItem(int index)
        {
            ...
            {
                Connect.ConnectToDB();
                Connect.CommandDB("DELETE FROM products WHERE id_product = {index};");
                Connect.OpenDB();
        ...
        bool Interface.AddItem(string name)
        {
            bool result = false;
            Connect.ConnectToDB();
            Connect.CommandDB("INSERT INTO products (name) VALUES ('{name}');");
